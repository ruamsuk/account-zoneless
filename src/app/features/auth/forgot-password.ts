  ...
  template: `
    <div class="min-h-screen bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
      <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md">
        <h2 class="text-3xl font-bold text-center text-gray-800 dark:text-gray-300 mb-2">Forgot Password</h2>
        ...
        @if (successMessage()) {
          ...
          <form [formGroup]="resetForm" (ngSubmit)="onSubmit()">
            <div class="mb-4">
              <label for="email" class="block text-gray-600 dark:text-gray-300 font-medium mb-2">Email Address</label>
