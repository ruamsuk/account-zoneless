...
@Component({
  ...
  template: `
      ...
      <nav class="container mx-auto px-4 md:px-8 py-3">
        <div class="flex justify-between items-center">
          <a routerLink="/" class="flex items-center gap-3">
            <img src="/images/primeng-logo.png" alt="logo" class="h-8 w-8"> <span
            class="text-2xl text-white font-semibold text-shadow-lg  font-serif">Account App</span>
          </a>
        ...
        @if (isMobileMenuOpen()) {
          <div class="md:hidden mt-4">
            <div class="flex flex-col gap-2">
              ...
              <a routerLink="/transactions" (click)="closeMobileMenu()" class="mobile-menu-item">Transactions</a>
              <div class="border-t dark:border-gray-700 pt-2 mt-2">
                <a (click)="logout()" class="mobile-menu-item text-red-500 w-full text-left">Logout</a>
              </div>
            </div>
          </div>
        }
            ...
            <div class="relative" #transactionsMenu>
              ...
              @if (isTransactionsMenuOpen()) {
                <div class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-700 rounded-md shadow-lg py-1 z-40">
                  ...
                  <a (click)="requestOpenModal()" class="dropdown-item">เพิ่มรายการใหม่</a>
                </div>
              }
            </div>
    ...
    <!--<header
      class="bg-white/80 shadow-md dark:bg-gray-800/80 dark:border-b dark:border-gray-700 sticky top-0 z-30 backdrop-blur-sm">
      <nav class="container mx-auto px-4 md:px-8 py-3">
        <div class="flex justify-between items-center">
          <a routerLink="/" class="flex items-center gap-3">
            <img src="/images/primeng-logo.png" alt="logo" class="h-8 w-8"> <span
            class="text-2xl text-gray-700 font-semibold dark:text-gray-300 font-thasadith">Account App</span>
          </a>
